...
<div class="main">
    <div class="main_content">
        ...
        <sec:authorize access="hasRole('ROLE_USER')">
            <H2>Доступ студентов к добавлению лекций запрещен!</H2>
            <br>
            <br>
                ...
                <form name="lesson_add" action="${pageContext.request.contextPath}/lessons_add" method="post">
                    <table border="2" align="center" cellspacing="5" cellpadding="15" rules="none">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <select class="select-group" id="selectGroup" name="lessonGroup"
                                        style="width: 135px; margin-right: 20px;">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <select class="selectTutor" id="selectTutor" name="lessonTutor"
